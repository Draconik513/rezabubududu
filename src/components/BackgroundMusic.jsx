    ...
    const updateAudio = () => {
      if (iframeRef.current) {
        ...
        try {
          ...
          iframe.src = `https://www.youtube.com/embed/yGRZUQCdwe8?autoplay=1&loop=1&playlist=yGRZUQCdwe8&enablejsapi=1&${isMusicPlaying ? 'mute=0' : 'mute=1'}`;
        } catch (error) {
    ...
    <>
      ...
      <div style={{ 
        ...
        <iframe
          ...
          width="1"
          height="1"
          src={`https://www.youtube.com/embed/yGRZUQCdwe8?autoplay=1&loop=1&playlist=yGRZUQCdwe8&enablejsapi=1&mute=0`}
